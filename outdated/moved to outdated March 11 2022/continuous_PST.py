...
random.seed(2022)
np.random.seed(2022)
test_track_directory = 'F:/My Drive/Research/memory_network/testmusic/'
...
class continuous_network():
    ...
    def __init__(self, N, density, input_density, gamma, beta, input_dimension):
        ...
        print(self.A[0])
        print(self.presyn_neighbor_list[0])
        ...
        if t>=t_start_recall and self.network_memory_gradient.solutions_array is not None:
            ...
            if self.use_local:
                ...
                for n in range(self.N): # for each node
                    ...
                    print("Check heeere")
                    print(np.shape(self.local_displacements))
                    ...
                    print("1234hi")
                    print(np.shape(self.diff_vector_list))
                    ...
                    print(np.shape(self.norm_vector_array))
                    print("end")
